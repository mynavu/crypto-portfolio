...
class UserState {
    ...
    toJSON() {
        return {
            ...
            rewardsIssuedCumulative: this.rewardsIssuedCumulative.map((item) => item.toString()),
    ...
    static fromJSON(obj) {
        return new UserState({
            ...
            rewardsIssuedCumulative: obj.rewardsIssuedCumulative.map((item) => new bn_js_1.default(item)),
