...
export declare class InvalidTransferOwnershipFarmStateDepositWarmupPeriod extends Error {
    readonly logs?: string[] | undefined;
    static readonly code = 6062;
    readonly code = 6062;
    readonly name = "InvalidTransferOwnershipFarmStateDepositWarmupPeriod";
    readonly msg = "Invalid farm state deposit warmup period for transfer ownership, must be 0 if old user has stake";
    constructor(logs?: string[] | undefined);
}
export declare class RewardUserOnceFeatureDisabled extends Error {
    readonly logs?: string[] | undefined;
...
export declare class InvalidDelegatedAuthorityUpdate extends Error {
    readonly logs?: string[] | undefined;
    static readonly code = 6064;
    readonly code = 6064;
    readonly name = "InvalidDelegatedAuthorityUpdate";
    readonly msg = "Can not set delegate_authority to default pubkey - farm is delegated";
    constructor(logs?: string[] | undefined);
}
export declare class UserTokenAccountOwnerMismatch extends Error {
    readonly logs?: string[] | undefined;
...
export declare class HarvestingNotPermissionlessPayerMismatch extends Error {
    readonly logs?: string[] | undefined;
    static readonly code = 6066;
    readonly code = 6066;
    readonly name = "HarvestingNotPermissionlessPayerMismatch";
    readonly msg = "Harvesting is not permissionless, payer does not match user state owner";
    constructor(logs?: string[] | undefined);
}
export declare class CurrentRewardIssuedUnclaimedMismatch extends Error {
    readonly logs?: string[] | undefined;
...
export declare class CannotCloseUserStateStakeNonZero extends Error {
    readonly logs?: string[] | undefined;
...
export declare class CannotCloseUserStatePendingUnstakes extends Error {
    readonly logs?: string[] | undefined;
    static readonly code = 6069;
    readonly code = 6069;
    readonly name = "CannotCloseUserStatePendingUnstakes";
    readonly msg = "Cannot close user state because there are pending unstake requests";
    constructor(logs?: string[] | undefined);
}
export declare class CannotCloseUserStatePendingDeposits extends Error {
    readonly logs?: string[] | undefined;
    static readonly code = 6070;
    readonly code = 6070;
    readonly name = "CannotCloseUserStatePendingDeposits";
    readonly msg = "Cannot close user state because there are pending deposit requests";
    constructor(logs?: string[] | undefined);
}
export declare class CannotCloseUserStateUnharvestedRewards extends Error {
    readonly logs?: string[] | undefined;
...
export declare class CannotCloseUserStateSignerNotOwner extends Error {
    readonly logs?: string[] | undefined;
...
export declare class CannotCloseUserStateDelegatedSignerNotDelegateAuthority extends Error {
    readonly logs?: string[] | undefined;
    static readonly code = 6073;
    readonly code = 6073;
    readonly name = "CannotCloseUserStateDelegatedSignerNotDelegateAuthority";
    readonly msg = "Cannot close user state (delegated) because signer is not the delegate authority";
    constructor(logs?: string[] | undefined);
}
export declare class CannotCloseUserStateRentReceiverNotOwner extends Error {
    readonly logs?: string[] | undefined;
    static readonly code = 6074;
    readonly code = 6074;
    readonly name = "CannotCloseUserStateRentReceiverNotOwner";
    readonly msg = "Cannot close user state because rent receiver is not the owner";
    constructor(logs?: string[] | undefined);
}
export declare class CannotCloseUserStateDelegatedRentReceiverNotAdmin extends Error {
    readonly logs?: string[] | undefined;
    static readonly code = 6075;
    readonly code = 6075;
    readonly name = "CannotCloseUserStateDelegatedRentReceiverNotAdmin";
    readonly msg = "Cannot close user state (delegated) because rent receiver is not the admin";
    constructor(logs?: string[] | undefined);
}
