...
exports.CannotCloseUserStateDelegatedRentReceiverNotAdmin = exports.CannotCloseUserStateRentReceiverNotOwner = exports.CannotCloseUserStateDelegatedSignerNotDelegateAuthority = exports.CannotCloseUserStateSignerNotOwner = exports.CannotCloseUserStateUnharvestedRewards = exports.CannotCloseUserStatePendingDeposits = exports.CannotCloseUserStatePendingUnstakes = exports.CannotCloseUserStateStakeNonZero = exports.CurrentRewardIssuedUnclaimedMismatch = exports.HarvestingNotPermissionlessPayerMismatch = exports.UserTokenAccountOwnerMismatch = exports.InvalidDelegatedAuthorityUpdate = exports.RewardUserOnceFeatureDisabled = exports.InvalidTransferOwnershipFarmStateDepositWarmupPeriod = exports.InvalidTransferOwnershipNewOwner = exports.InvalidTransferOwnershipStakeAmount = exports.InvalidTransferOwnershipFarmStateWithdrawCooldownPeriod = exports.InvalidTransferOwnershipFarmStateLockingMode = exports.InvalidTransferOwnershipUserStateOwnerDelegatee = exports.InvalidTransferOwnershipFarmState = exports.InvalidTransferOwnershipOldOwner = exports.InvalidFarmConfigUpdateAuthority = exports.UnsupportedTokenExtension = exports.RewardScheduleCurveSet = exports.WithdrawRewardZeroAvailable = exports.RewardAtaOwnerNotAdmin = void 0;
...
class InvalidTransferOwnershipFarmStateDepositWarmupPeriod extends Error {
    logs;
    static code = 6062;
    code = 6062;
    ...
    constructor(logs) {
        super("6062: Invalid farm state deposit warmup period for transfer ownership, must be 0 if old user has stake");
        this.logs = logs;
    }
}
exports.InvalidTransferOwnershipFarmStateDepositWarmupPeriod = InvalidTransferOwnershipFarmStateDepositWarmupPeriod;
class RewardUserOnceFeatureDisabled extends Error {
    logs;
    static code = 6063;
    code = 6063;
...
exports.RewardUserOnceFeatureDisabled = RewardUserOnceFeatureDisabled;
class InvalidDelegatedAuthorityUpdate extends Error {
    logs;
    static code = 6064;
    code = 6064;
    ...
    constructor(logs) {
        super("6064: Can not set delegate_authority to default pubkey - farm is delegated");
        this.logs = logs;
    }
}
exports.InvalidDelegatedAuthorityUpdate = InvalidDelegatedAuthorityUpdate;
class UserTokenAccountOwnerMismatch extends Error {
    logs;
    static code = 6065;
    code = 6065;
...
exports.UserTokenAccountOwnerMismatch = UserTokenAccountOwnerMismatch;
class HarvestingNotPermissionlessPayerMismatch extends Error {
    logs;
    static code = 6066;
    code = 6066;
    ...
    constructor(logs) {
        super("6066: Harvesting is not permissionless, payer does not match user state owner");
        this.logs = logs;
    }
}
exports.HarvestingNotPermissionlessPayerMismatch = HarvestingNotPermissionlessPayerMismatch;
class CurrentRewardIssuedUnclaimedMismatch extends Error {
    logs;
    static code = 6067;
    code = 6067;
...
exports.CurrentRewardIssuedUnclaimedMismatch = CurrentRewardIssuedUnclaimedMismatch;
class CannotCloseUserStateStakeNonZero extends Error {
    logs;
    static code = 6068;
    code = 6068;
...
exports.CannotCloseUserStateStakeNonZero = CannotCloseUserStateStakeNonZero;
class CannotCloseUserStatePendingUnstakes extends Error {
    logs;
    static code = 6069;
    code = 6069;
    ...
    constructor(logs) {
        super("6069: Cannot close user state because there are pending unstake requests");
        this.logs = logs;
    }
}
exports.CannotCloseUserStatePendingUnstakes = CannotCloseUserStatePendingUnstakes;
class CannotCloseUserStatePendingDeposits extends Error {
    logs;
    static code = 6070;
    code = 6070;
    ...
    constructor(logs) {
        super("6070: Cannot close user state because there are pending deposit requests");
        this.logs = logs;
    }
}
exports.CannotCloseUserStatePendingDeposits = CannotCloseUserStatePendingDeposits;
class CannotCloseUserStateUnharvestedRewards extends Error {
    logs;
    static code = 6071;
    code = 6071;
...
exports.CannotCloseUserStateUnharvestedRewards = CannotCloseUserStateUnharvestedRewards;
class CannotCloseUserStateSignerNotOwner extends Error {
    logs;
    static code = 6072;
    code = 6072;
...
exports.CannotCloseUserStateSignerNotOwner = CannotCloseUserStateSignerNotOwner;
class CannotCloseUserStateDelegatedSignerNotDelegateAuthority extends Error {
    logs;
    static code = 6073;
    code = 6073;
    ...
    constructor(logs) {
        super("6073: Cannot close user state (delegated) because signer is not the delegate authority");
        this.logs = logs;
    }
}
exports.CannotCloseUserStateDelegatedSignerNotDelegateAuthority = CannotCloseUserStateDelegatedSignerNotDelegateAuthority;
class CannotCloseUserStateRentReceiverNotOwner extends Error {
    logs;
    static code = 6074;
    code = 6074;
    ...
    constructor(logs) {
        super("6074: Cannot close user state because rent receiver is not the owner");
        this.logs = logs;
    }
}
exports.CannotCloseUserStateRentReceiverNotOwner = CannotCloseUserStateRentReceiverNotOwner;
class CannotCloseUserStateDelegatedRentReceiverNotAdmin extends Error {
    logs;
    static code = 6075;
    code = 6075;
    ...
    constructor(logs) {
        super("6075: Cannot close user state (delegated) because rent receiver is not the admin");
        this.logs = logs;
    }
}
exports.CannotCloseUserStateDelegatedRentReceiverNotAdmin = CannotCloseUserStateDelegatedRentReceiverNotAdmin;
