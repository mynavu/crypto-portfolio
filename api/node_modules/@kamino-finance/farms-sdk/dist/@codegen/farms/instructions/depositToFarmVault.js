...
exports.DISCRIMINATOR = Buffer.from([131, 166, 64, 94, 108, 213, 114, 183]);
exports.layout = borsh.struct([borsh.u64("amount")]);
function depositToFarmVault(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=depositToFarmVault.js.map