...
exports.DISCRIMINATOR = Buffer.from([68, 200, 228, 233, 184, 32, 226, 188]);
exports.layout = borsh.struct([borsh.u64("rewardIndex")]);
function harvestReward(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
