...
exports.setStakeDelegated = setStakeDelegated;
const borsh = __importStar(require("@coral-xyz/borsh")); // eslint-disable-line @typescript-eslint/no-unused-vars
const programId_1 = require("../programId");
exports.DISCRIMINATOR = Buffer.from([73, 171, 184, 75, 30, 56, 198, 223]);
exports.layout = borsh.struct([borsh.u64("newAmount")]);
function setStakeDelegated(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=setStakeDelegated.js.map