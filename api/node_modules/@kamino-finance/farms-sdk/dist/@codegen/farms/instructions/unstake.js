...
exports.DISCRIMINATOR = Buffer.from([90, 95, 107, 42, 205, 124, 50, 225]);
exports.layout = borsh.struct([borsh.u128("stakeSharesScaled")]);
function unstake(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
