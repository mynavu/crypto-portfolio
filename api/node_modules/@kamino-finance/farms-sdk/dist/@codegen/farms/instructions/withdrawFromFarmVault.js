...
exports.DISCRIMINATOR = Buffer.from([22, 82, 128, 250, 86, 79, 124, 78]);
exports.layout = borsh.struct([borsh.u64("amount")]);
function withdrawFromFarmVault(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
...
//# sourceMappingURL=withdrawFromFarmVault.js.map