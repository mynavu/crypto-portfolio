...
exports.DISCRIMINATOR = Buffer.from([40, 63, 122, 158, 144, 216, 83, 96]);
exports.layout = borsh.struct([borsh.u64("amount")]);
function withdrawTreasury(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
