...
class UpdateIsRewardUserOnceEnabled {
    static discriminator = 22;
    static kind = "UpdateIsRewardUserOnceEnabled";
    discriminator = 22;
...
exports.UpdateIsRewardUserOnceEnabled = UpdateIsRewardUserOnceEnabled;
class UpdateDelegatedAuthority {
    static discriminator = 23;
    static kind = "UpdateDelegatedAuthority";
    discriminator = 23;
...
exports.UpdateDelegatedAuthority = UpdateDelegatedAuthority;
class UpdateIsHarvestingPermissionless {
    static discriminator = 24;
    static kind = "UpdateIsHarvestingPermissionless";
    discriminator = 24;
...
exports.UpdateIsHarvestingPermissionless = UpdateIsHarvestingPermissionless;
