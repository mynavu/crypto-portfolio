...
export declare class Farms {
    ...
    rewardUserOnceIx(delegateAuthority: TransactionSigner, farmState: FarmAndKey, userState: Address, rewardMint: Address, amountLamports: BN, expectedRewardIssuedUnclaimed: BN): Promise<Instruction>;
    ...
    updateFarmConfigIx(admin: TransactionSigner, farm: Address, mint: Address, mode: FarmConfigOptionKind, value: number | Address | number[] | RewardCurvePoint[] | BN, rewardIndexOverride?: number, scopePricesOverride?: Option<Address>, newFarm?: boolean): Promise<Instruction>;
    ...
    updateGlobalConfigIx(admin: TransactionSigner, globalConfig: Address, mode: GlobalConfigOptionKind, flagValue: string, flagValueType: GlobalConfigFlagValueType): Promise<Instruction>;
    ...
    withdrawTreasuryIx(admin: TransactionSigner, globalConfig: Address, rewardMint: Address, rewardTokenProgram: Address, amount: BN, withdrawAta?: Address): Promise<Instruction>;
