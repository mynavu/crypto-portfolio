...
export declare function rewardUserOnce(delegateAuthority: TransactionSigner, farmState: Address, userState: Address, rewardIndex: number, amount: BN, expectedRewardIssuedUnclaimed: BN): IInstruction;
...
export declare function closeEmptyUserState(signer: TransactionSigner, userState: Address, farmState: Address, rentReceiver: Address): IInstruction;
...
export declare function transferOwnership(oldOwner: TransactionSigner, oldUserState: Address, newOwner: Address, farmState: Address, newUserState: Address, scopePrices: Option<Address>, payer?: TransactionSigner): IInstruction;
