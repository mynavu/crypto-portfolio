...
function rewardUserOnce(delegateAuthority, farmState, userState, rewardIndex, amount, expectedRewardIssuedUnclaimed) {
    let accounts = {
        delegateAuthority,
        farmState,
        userState,
    ...
    return (0, instructions_1.rewardUserOnce)(args, accounts);
}
...
function closeEmptyUserState(signer, userState, farmState, rentReceiver) {
    ...
    return (0, instructions_1.closeEmptyUserState)(accounts);
}
function updateFarmConfig(farmAdmin, farmState, scopePrices, rewardIndex, mode, value) {
    ...
    switch (mode.discriminator) {
        ...
        case FarmConfigOption_1.WithdrawCooldownPeriod.discriminator:
            ...
            data = Uint8Array.from(buffer);
            break;
        case FarmConfigOption_1.UpdateIsHarvestingPermissionless.discriminator:
        ...
        case FarmConfigOption_1.UpdateDelegatedAuthority.discriminator:
        ...
        case FarmConfigOption_1.UpdateRewardScheduleCurvePoints.discriminator:
            ...
            break;
        case FarmConfigOption_1.UpdateIsRewardUserOnceEnabled.discriminator:
            buffer = Buffer.alloc(1);
            buffer.writeUInt8(value, 0);
            data = Uint8Array.from(buffer);
            break;
