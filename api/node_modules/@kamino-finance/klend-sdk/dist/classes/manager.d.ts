...
export declare class KaminoManager {
    ...
    constructor(rpc: Rpc<SolanaRpcApi>, recentSlotDurationMs?: number, kaminoLendProgramId?: Address, kaminoVaultProgramId?: Address, cdnResources?: CdnResources);
     ...
     */
    buyVaultSharesIxs(user: TransactionSigner, vault: KaminoVault, tokenAmount: Decimal, vaultReservesMap?: Map<Address, KaminoReserve>, farmState?: FarmState): Promise<DepositIxs>;
    /**
     ...
     * @returns an array of instructions to create missing ATAs if needed and the withdraw instructions
     */
    sellVaultSharesIxs(user: TransactionSigner, vault: KaminoVault, shareAmount: Decimal, slot: Slot, vaultReservesMap?: Map<Address, KaminoReserve>, farmState?: FarmState): Promise<WithdrawIxs>;
    /**
