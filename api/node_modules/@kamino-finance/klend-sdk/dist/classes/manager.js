...
class KaminoManager {
    ...
    constructor(rpc, recentSlotDurationMs, kaminoLendProgramId, kaminoVaultProgramId, cdnResources) {
        this._rpc = rpc;
        ...
        this._vaultClient = new vault_1.KaminoVaultClient(rpc, this.recentSlotDurationMs, this._kaminoVaultProgramId, this._kaminoLendProgramId, cdnResources);
    }
    getRpc() {
        return this._rpc;
    }
     ...
     */
    async buyVaultSharesIxs(user, vault, tokenAmount, vaultReservesMap, farmState) {
     ...
     * @returns an array of instructions to create missing ATAs if needed and the withdraw instructions
     */
    async sellVaultSharesIxs(user, vault, shareAmount, slot, vaultReservesMap, farmState) {
        ...
        const combinedMarkets = lendingMarketPairs.map(([pubkey, market]) => {
            ...
            if (!reserves) {
                ...
                reservesAndOracles.forEach(([reserve, oracle], index) => {
                    ...
                    const kaminoReserve = lib_1.KaminoReserve.initialize(address, state, oracle, this.getRpc(), this.recentSlotDurationMs, cdnResourcesData);
