...
class KaminoVaultClient {
    ...
    async depositIxs(user, vault, tokenAmount, vaultReservesMap, farmState) {
        ...
        if (!farmState && (await vault.hasFarm(vaultState))) {
            const vaultFarmStateResult = await dist_1.FarmState.fetch(this.getConnection(), vaultState.vaultFarm);
    ...
    async withdrawIxs(user, vault, shareAmountToWithdraw, slot, vaultReservesMap, farmState) {
        ...
        return this.buildShareExitIxs('withdraw', user, vault, shareAmountToWithdraw, slot, vaultReservesMap, vaultFarmState);
    }
    /**
