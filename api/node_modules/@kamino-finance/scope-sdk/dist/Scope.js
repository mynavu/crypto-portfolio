...
class ScopeEntryMetadata {
    ...
    get generic() {
        ...
        switch (this.priceTypeId) {
            ...
            case types_1.OracleType.CappedMostRecentOf.discriminator:
                return types_1.CappedMostRecentOfData.fromDecoded(types_1.CappedMostRecentOfData.layout().decode(buffer));
            default:
                return null;
        }
    }
        ...
        switch (this.priceTypeId) {
            case types_1.OracleType.MostRecentOf.discriminator: {
                ...
                const sources = generic.sourceEntries
                    .filter((idx) => idx !== 512 && idx !== constants_1.U16_MAX)
