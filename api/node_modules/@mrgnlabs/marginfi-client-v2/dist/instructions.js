...
async function makeKaminoDepositIx(mfProgram, accounts, args, remainingAccounts = []) {
    const { marginfiAccount, bank, signerTokenAccount, lendingMarket, reserveLiquidityMint, lendingMarketAuthority, reserveLiquiditySupply, reserveCollateralMint, reserveDestinationDepositCollateral, liquidityTokenProgram, obligationFarmUserState, reserveFarmState, ...optionalAccounts } = accounts;
    return mfProgram.methods
...
async function makeKaminoWithdrawIx(mfProgram, accounts, args, remainingAccounts = []) {
    const { marginfiAccount, bank, destinationTokenAccount, lendingMarket, reserveLiquidityMint, lendingMarketAuthority, reserveLiquiditySupply, reserveCollateralMint, reserveSourceCollateral, liquidityTokenProgram, obligationFarmUserState, reserveFarmState, ...optionalAccounts } = accounts;
    return mfProgram.methods
...
async function makeAccountTransferToNewAccountIx(mfProgram, accounts) {
    const { oldMarginfiAccount, newMarginfiAccount, newAuthority, globalFeeWallet, feePayer, ...optionalAccounts } = accounts;
    return mfProgram.methods
