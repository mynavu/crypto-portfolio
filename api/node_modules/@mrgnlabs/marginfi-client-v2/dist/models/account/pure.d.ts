...
declare class MarginfiAccount implements MarginfiAccountType {
    ...
    makeBeginFlashLoanIx(program: MarginfiProgram, endIndex: number, authority?: PublicKey): Promise<InstructionsWrapper>;
    makeEndFlashLoanIx(program: MarginfiProgram, bankMap: Map<string, Bank>, projectedActiveBalances: PublicKey[], authority?: PublicKey): Promise<InstructionsWrapper>;
