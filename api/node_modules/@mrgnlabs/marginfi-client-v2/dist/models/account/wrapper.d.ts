...
declare class MarginfiAccountWrapper {
     ...
     */
    makeBeginFlashLoanIx(endIndex: number, authority?: PublicKey): Promise<InstructionsWrapper>;
    /**
     ...
     */
    makeEndFlashLoanIx(projectedActiveBalances: PublicKey[], authority?: PublicKey): Promise<InstructionsWrapper>;
    ...
    buildFlashLoanTx(args: FlashLoanArgs, lookupTables?: AddressLookupTableAccount[], authority?: PublicKey): Promise<ExtendedV0Transaction>;
    makeAccountTransferToNewAccountIx(newMarginfiAccount: PublicKey, newAccountAuthority: PublicKey, globalFeeWallet: PublicKey, feePayer: PublicKey): Promise<InstructionsWrapper>;
    makeAccountTransferToNewAccountTx(newMarginfiAccount: PublicKey, newAccountAuthority: PublicKey, feePayer: PublicKey): Promise<Transaction>;
