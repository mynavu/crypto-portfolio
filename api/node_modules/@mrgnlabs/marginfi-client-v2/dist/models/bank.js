...
class Bank {
    ...
    static fromBankType(bankType) {
        const config = new BankConfig(bankType.config.assetWeightInit, bankType.config.assetWeightMaint, bankType.config.liabilityWeightInit, bankType.config.liabilityWeightMaint, bankType.config.depositLimit, bankType.config.borrowLimit, bankType.config.riskTier, bankType.config.totalAssetValueInitLimit, bankType.config.assetTag, bankType.config.oracleSetup, bankType.config.oracleKeys, bankType.config.oracleMaxAge, bankType.config.interestRateConfig, bankType.config.operationalState, bankType.config.oracleMaxConfidence, bankType.config.fixedPrice, bankType.config.configFlags);
        return new Bank(bankType.address, bankType.mint, bankType.mintDecimals, bankType.group, bankType.mintRate, bankType.mintPrice, bankType.assetShareValue, bankType.liabilityShareValue, bankType.liquidityVault, bankType.liquidityVaultBump, bankType.liquidityVaultAuthorityBump, bankType.insuranceVault, bankType.insuranceVaultBump, bankType.insuranceVaultAuthorityBump, bankType.collectedInsuranceFeesOutstanding, bankType.feeVault, bankType.feeVaultBump, bankType.feeVaultAuthorityBump, bankType.collectedGroupFeesOutstanding, bankType.lastUpdate, config, bankType.totalAssetShares, bankType.totalLiabilityShares, bankType.emissionsActiveBorrowing, bankType.emissionsActiveLending, bankType.emissionsRate, bankType.emissionsMint, bankType.emissionsRemaining, bankType.oracleKey, bankType.emode, bankType.kaminoIntegrationAccounts, bankType.driftIntegrationAccounts, bankType.solendIntegrationAccounts, bankType.feesDestinationAccount, bankType.lendingPositionCount, bankType.borrowingPositionCount, bankType.tokenSymbol);
    }
    static fromAccountParsed(address, accountParsed, feedIdMap, bankMetadata) {
        const props = (0, utils_1.parseBankRaw)(address, accountParsed, bankMetadata);
        return new Bank(props.address, props.mint, props.mintDecimals, props.group, props.mintRate, props.mintPrice, props.assetShareValue, props.liabilityShareValue, props.liquidityVault, props.liquidityVaultBump, props.liquidityVaultAuthorityBump, props.insuranceVault, props.insuranceVaultBump, props.insuranceVaultAuthorityBump, props.collectedInsuranceFeesOutstanding, props.feeVault, props.feeVaultBump, props.feeVaultAuthorityBump, props.collectedGroupFeesOutstanding, props.lastUpdate, props.config, props.totalAssetShares, props.totalLiabilityShares, props.emissionsActiveBorrowing, props.emissionsActiveLending, props.emissionsRate, props.emissionsMint, props.emissionsRemaining, props.oracleKey, props.emode, props.kaminoIntegrationAccounts, props.driftIntegrationAccounts, props.solendIntegrationAccounts, props.feesDestinationAccount, props.lendingPositionCount, props.borrowingPositionCount, props.tokenSymbol);
    }
...
class BankConfig {
    ...
    static fromAccountParsed(bankConfigRaw) {
        ...
        return new BankConfig(bankConfig.assetWeightInit, bankConfig.assetWeightMaint, bankConfig.liabilityWeightInit, bankConfig.liabilityWeightMaint, bankConfig.depositLimit, bankConfig.borrowLimit, bankConfig.riskTier, bankConfig.totalAssetValueInitLimit, bankConfig.assetTag, bankConfig.oracleSetup, bankConfig.oracleKeys, bankConfig.oracleMaxAge, bankConfig.interestRateConfig, bankConfig.operationalState, bankConfig.oracleMaxConfidence, bankConfig.fixedPrice, bankConfig.configFlags);
    }
}
