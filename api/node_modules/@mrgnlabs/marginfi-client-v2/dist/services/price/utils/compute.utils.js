...
function parseOraclePriceData(oracleSetup, rawData, fixedPrice) {
    ...
    switch (oracleSetup) {
        ...
        case bank_1.OracleSetup.KaminoPythPush:
        case bank_1.OracleSetup.DriftPythPull:
        case bank_1.OracleSetup.SolendPythPull: {
        ...
        case bank_1.OracleSetup.KaminoSwitchboardPull:
        case bank_1.OracleSetup.DriftSwitchboardPull:
        case bank_1.OracleSetup.SolendSwitchboardPull: {
        ...
        case bank_1.OracleSetup.Fixed: {
            const price = fixedPrice ?? (0, bignumber_js_1.default)(0);
            const fixedOraclePrice = {
                ...
                timestamp: (0, bignumber_js_1.default)(Date.now()),
            };
...
function parseSwbOraclePriceData(price, stdDev, timestamp) {
    const swbPrice = (0, bn_js_1.isBN)(price)
        ? new bignumber_js_1.default(price.toString()).div(10 ** switchboard_pull_1.SWITCHBOARD_ONDEMANDE_PRICE_PRECISION)
        : new bignumber_js_1.default((0, mrgn_common_1.median)(price));
    const swbConfidence = new bignumber_js_1.default(stdDev.toString()).times(constants_1.SWB_PRICE_CONF_INTERVALS);
    const swbConfidenceCapped = capConfidenceInterval(swbPrice, swbConfidence, constants_1.MAX_CONFIDENCE_INTERVAL_RATIO);
    const swbLowestPrice = swbPrice.minus(swbConfidenceCapped);
    const swbHighestPrice = swbPrice.plus(swbConfidenceCapped);
    return {
