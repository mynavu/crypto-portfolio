...
exports.reserveToString = exports.parseReserve = exports.isReserve = exports.RESERVE_SIZE = exports.ReserveLayout = exports.AssetType = void 0;
...
function decodeReserve(buffer, pubkey) {
    ...
    return {
        ...
        config: {
            ...
            borrowWeight: reserve.addedBorrowWeightBPS.toString() === constants_1.U64_MAX
                ? constants_1.U64_MAX
                : new bignumber_js_1.default(reserve.addedBorrowWeightBPS.toString())
